...
-(void)prepareAlertToDisplay:(XYAlertView*)entity
{
    ...
    UILabel *_titleLabel = [[[UILabel alloc] initWithFrame:CGRectMake(25, 15, 240, 30)] autorelease];
    ...
    UILabel *_messageLabel = [[[UILabel alloc] initWithFrame:CGRectMake(25, 35, 240, 60)] autorelease];
