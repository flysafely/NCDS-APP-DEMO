...
-(UIImage*)backgroundImage
{
    ...
    if(myWhite > 0.0f){
        gradientTopColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"sys_bg"]];
        gradientMiddleColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"sys_bg"]];
        gradientBottomColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"sys_bg"]];
    } else {
        gradientTopColor = [UIColor colorWithRed:myRed+0.35f green:myGreen+0.35f blue:myBlue+0.35f alpha: 0.1];
        gradientMiddleColor = [UIColor colorWithRed:myRed+0.13f green:myGreen+0.13f blue:myBlue+0.13f alpha: 0.1];
        gradientBottomColor = [UIColor colorWithRed:myRed green:myGreen blue:myBlue alpha: 0.1];
    }
