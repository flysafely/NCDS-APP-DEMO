...
- (id)initWithTitle:(NSString *)title 
{
    if ((self = [super init]))
    {
        ...
        self.cornerRadius = CORNER_RADIUS;//并没有实现这个函数....
...
- (void)addButtonWithTitle:(NSString *)title block:(void (^)())block 
{
    ...
    [self addButtonWithTitle:title
                       color:[UIColor colorWithPatternImage:[UIImage imageNamed:@"btnFinish"]]
...
{
    [self addButtonWithTitle:title
                       color:[UIColor colorWithPatternImage:[UIImage imageNamed:@"cancel_bt"]]
                  titleColor:[UIColor whiteColor]
                 borderWidth:0
                 borderColor:[UIColor blackColor]
                       block:block];
