...
- (void) showPopoverWithPoint:(CGPoint)senderPoint
{
    ...
    if(self.titleText){
        titleLabel = [[[UILabel alloc] initWithFrame:CGRectMake(backgroundPositionX, backgroundPositionY, contentViewFrame.size.width+MARGIN*2, TITLE_LABEL_HEIGHT+MARGIN)] autorelease];
    ...
    popoverView.baseColor = [UIColor grayColor];
